...
这份目录面向第一次接触 Personal Agent 的读者：先从当前功能和运行方式理解系统，再按主题深入。历史设计和取舍记录在 [`design/`](../design/index.md)，当前事实以 `README.md`、本目录和代码为准。
...
| weekly summary、daily memory、knowledge index、script 投喂 | [定时任务](schedules.md) |
